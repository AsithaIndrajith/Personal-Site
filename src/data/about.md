...
I love to code and I want to pursue a career in machine learning. During my time at the [University of Colombo](https://cmb.ac.lk/), where I studied for a Computer Science Bachelor's degree (Hons), I had the opportunity to work with many people from different disciplines in the team which helped me build strong communication skills by sharing my knowledge and opinions. I did several projects that involved making Mobile/Web applications and Deep learning research while working at [SCoRe LAB](https://scorelab.org/). My final year research was a deep learning-based computer vision problem.

# Currently

At CodeGen International, I have learned how to build teams, manage people, shape culture, develop relationships with member, sell enterprise products, and build on-line systems with technologies like Java, Spring Boot, Python, and spaCy. I primarily work as a software engineer but have broad experience across various NFR testings.

<!-- # Some history -->

<!-- - My parents got me a computer for me in 2001 when I was 6. It was an old Pentium-4 that ran MS Windows97. My favorite games were Street Rod 2, Wolfenstein 3D, and Tom and Jerry. It had a mechanical keyboard and a turbo button. To this day, I still don't know what pressing the turbo button really did.
